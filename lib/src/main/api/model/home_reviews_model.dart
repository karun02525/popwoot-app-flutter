...
HomeReviewModel storeModelFromJson(String str) => HomeReviewModel.fromJson(json.decode(str));

String storeModelToJson(HomeReviewModel data) => json.encode(data.toJson());
